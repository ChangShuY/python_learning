...
iter=0,cost=1921
iter=50,cost=16470
iter=100,cost=143890
iter=150,cost=1257119
iter=200,cost=10982997
iter=250,cost=95954360
iter=300,cost=838318592
iter=350,cost=7324084736
iter=400,cost=63987814400
iter=450,cost=559038267392
9a+5b+2c+10d=[-6493728.5]
'''
...
#生成数据
np.random.seed(0)
outputs = np.random.randint(5, size=(21, 4))
res = []
for i in range(21):
